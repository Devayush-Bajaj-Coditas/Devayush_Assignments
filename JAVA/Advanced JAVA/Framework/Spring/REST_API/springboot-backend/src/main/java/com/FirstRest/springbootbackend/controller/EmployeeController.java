package com.FirstRest.springbootbackend.controller;

import com.FirstRest.springbootbackend.exception.ResourceNotFoundException;
...
@GetMapping("{id}")
    ...
    @PutMapping("{id}")
    public ResponseEntity<Employee> updateEmployee(long id, @RequestBody Employee employeeDetails){
